...
class THMCacheManager: NSObject {
    
    static let shared = THMCacheManager()

    private let fileManager = FileManager.default

    func loadVideo(from url: URL, completion: @escaping (Result2<URL>) -> Void) {
...
private extension THMCacheManager {

    func createCacheDirectory() -> Result2<URL> {
    ...
    func downloadAndCacheVideo(from url: URL, completion: @escaping (Result2<URL>) -> Void) {
...
extension THMCacheManager: URLSessionDelegate {
    func urlSession(
